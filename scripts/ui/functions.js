export default class UiFns {
  ...
  updatePatternInfo(patternPartial, path) {
    const titleSplit = this.#root.document.title.split(this.uiProps.titleSeparator);
