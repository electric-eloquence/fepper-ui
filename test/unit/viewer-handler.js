...
//    });
//
//    xit('swaps in encoded HTML', function () {
...
//    });
//
//    xit('swaps in Mustache-like Feplet', function () {
...
//    });
//
//    xit('does nothing if .codeActive is false', function () {
...
//    });
//
//    xit('does nothing if .mustacheBrowser is true', function () {
//      codeViewer.codeActive = false;
...
//    });
//
//    xit('toggles on - also tests .openCode()', function () {
//      codeViewer.closeCode();
//
//      $orgs['#sg-t-code'].dispatchAction('removeClass', 'active');
...
//    });
//
//    xit('toggles off - also tests .closeCode()', function () {
//      const sgCodeContainerBefore = $orgs['#sg-code-container'].getState();
//      const sgTCodeBefore = $orgs['#sg-t-code'].getState();
//      const sgVpWrapBefore = $orgs['#sg-vp-wrap'].getState();
//
...
//    });
//
//    xit('toggles on - also closes annotations viewer', function () {
...
//    xit('updates code with lineage array', function () {
//      const sgCodeContainerBefore = $orgs['#sg-code-container'].getState();
//      const sgCodeLineageBefore = $orgs['#sg-code-lineage'].getState();
//      const sgCodeLineageFillBefore = $orgs['#sg-code-lineage-fill'].getState();
//      const sgCodeLineagerBefore = $orgs['#sg-code-lineager'].getState();
...
//    });
//
//    xit('updates code with lineageR array', function () {
//      const sgCodeContainerBefore = $orgs['#sg-code-container'].getState();
//      const sgCodeLineageBefore = $orgs['#sg-code-lineage'].getState();
//      const sgCodeLineageFillBefore = $orgs['#sg-code-lineage-fill'].getState();
//      const sgCodeLineagerBefore = $orgs['#sg-code-lineager'].getState();
...
//
//    xit('updates code with pattern state', function () {
//      const sgCodeContainerBefore = $orgs['#sg-code-container'].getState();
//      const sgCodeLineageBefore = $orgs['#sg-code-lineage'].getState();
//      const sgCodeLineageFillBefore = $orgs['#sg-code-lineage-fill'].getState();
//      const sgCodeLineagerBefore = $orgs['#sg-code-lineager'].getState();
...
//    xit('returns a function that prints the XHR error given protocol "http:"', function () {
//      global.location = {
//        protocol: 'file:'
//      };
...
//    });
//
//    xit('returns a function that prints the XHR error given protocol "file:" and no status', function () {
//      global.location = {
//        protocol: 'file:'
//      };
...
//    });
//
//    xit('updates code on data.codeOverlay = "on"', function () {
//      event.data = {
//        codeOverlay: 'on',
//        lineage: [],
//        lineageR: [],
...
//    });
//
//    xit('updates code on data.codeOverlay = "on" and data.viewall = true', function () {
//      event.data = {
//        codeOverlay: 'on',
//        lineage: [],
//        lineageR: [],
...
//    });
//
//    xit('opens and updates code on data.codeOverlay = "on", data.viewall = true, and data.openCode = true', function () {
//      event.data = {
//        codeOverlay: 'on',
//        lineage: [],
//        lineageR: [],
...
//    });
//
//    xit('closes code on data.codeOverlay = "off"', function () {
//      event.data = {
//        codeOverlay: 'off'
//      };
//
...
//    });
//
//    xit('sets .mustacheBrowser on data.codeMustacheBrowser = true', function () {
//      event.data = {
...
//    });
//
//    xit('sets .mustacheBrowser on data.codeMustacheBrowser = false', function () {
//      event.data = {
...
//    });
//
//    xit('sets .viewall on data.codeViewall = true', function () {
//      event.data = {
//        codeViewall: true
//      };
//
...
//    });
//
//    xit('sets .viewall on data.codeViewall = false', function () {
//      event.data = {
//        codeViewall: false
//      };
//
...
//    });
//
//    xit('toggles code on on patternlab.keyPress "ctrl+shift+c"', function () {
//      event.data = {
...
//    });
//
//    xit('toggles code off on patternlab.keyPress "ctrl+shift+c"', function () {
//      event.data = {
//        event: 'patternlab.keyPress',
//        keyPress: 'ctrl+shift+c'
//      };
...
//    });
//
//    xit('swaps in encoded HTML on patternlab.keyPress "ctrl+alt+h"', function () {
//      event.data = {
//        event: 'patternlab.keyPress',
//        keyPress: 'ctrl+alt+h'
//      };
...
//    });
//
//    xit('swaps in encoded HTML on patternlab.keyPress "ctrl+shift+y"', function () {
//      event.data = {
//        event: 'patternlab.keyPress',
...
//    });
//
//    xit('swaps in Mustache-like Feplet on patternlab.keyPress "ctrl+alt+m"', function () {
//      event.data = {
//        event: 'patternlab.keyPress',
//        keyPress: 'ctrl+alt+m'
//      };
...
//    });
//
//    xit('swaps in Mustache-like Feplet on patternlab.keyPress "ctrl+shift+u"', function () {
//      event.data = {
//        event: 'patternlab.keyPress',
...
//    });
//
//    xit('closes codeViewer on patternlab.keyPress "esc"', function () {
//      event.data = {
//        event: 'patternlab.keyPress',
//        keyPress: 'esc'
//      };
